        ...
        run: |
          ...
          *Generated by QA Agent*"""
          ...
          if gh_response.status_code == 201:
              ...
              print(f"⚠️ GitHub post failed: {gh_response.status_code}")
          ...
          if notion_token and notion_db:
              ...
              test_breakdown.append({
                  ...
                  "type": "heading_2",
                  "heading_2": {
                      "rich_text": [{"type": "text", "text": {"content": "📊 Test Execution Summary"}}]
                  }
              })
              ...
              if metrics['test_names']:
                  ...
                  for test in metrics['test_names'][:20]:
                      emoji = "✅" if test['status'] == "PASSED" else "❌" if test['status'] == "FAILED" else "🔴"
              ...
              if notion_response.status_code == 200:
                  ...
                  print(f"⚠️ Notion post failed: {notion_response.status_code}")
