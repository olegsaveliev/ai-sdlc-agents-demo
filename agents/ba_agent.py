...
def add_analysis_to_notion_page(page_id, analysis):
    ...
    if response.status_code == 200:
        print(f"✅ Added analysis to original Notion page")
    else:
        print(f"⚠️ Failed to add analysis to Notion page: {response.status_code}")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if results:
                ...
                print(f"📄 Found original Notion page, updating...")
                ...
                print("ℹ️ No matching Notion page found (issue not created from Notion)")
        else:
            print(f"⚠️ Failed to query Notion: {response.status_code}")
    
    except Exception as e:
        print(f"⚠️ Error updating original Notion page: {e}")
...
def main():
    ...
    try:
        ...
        print("🔄 Checking for original Notion page...")
